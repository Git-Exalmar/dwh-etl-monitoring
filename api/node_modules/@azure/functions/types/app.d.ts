...
import { ConnectorTriggerFunctionOptions } from '@azure/functions/types/connectorTrigger';
import { CosmosDBFunctionOptions } from '@azure/functions/types/cosmosDB';
import { EventGridEvent, EventGridFunctionOptions } from '@azure/functions/types/eventGrid';
import { EventHubFunctionOptions } from '@azure/functions/types/eventHub';
import { GenericFunctionOptions } from '@azure/functions/types/generic';
import { HttpFunctionOptions, HttpHandler, HttpMethodFunctionOptions } from '@azure/functions/types/http';
import { McpPromptFunctionOptions } from '@azure/functions/types/mcpPrompt';
import { McpResourceFunctionOptions } from '@azure/functions/types/mcpResource';
import { McpToolFunctionOptions } from '@azure/functions/types/mcpTool';
import { MySqlFunctionOptions } from '@azure/functions/types/mySql';
import { ServiceBusQueueFunctionOptions, ServiceBusTopicFunctionOptions } from '@azure/functions/types/serviceBus';
import { SetupOptions } from '@azure/functions/types/setup';
import { SqlFunctionOptions } from '@azure/functions/types/sql';
...
import { WarmupFunctionOptions } from '@azure/functions/types/warmup';
import { WebPubSubFunctionOptions } from '@azure/functions/types/webpubsub';
...
export * as hook from '@azure/functions/types/hooks/registerHook';
