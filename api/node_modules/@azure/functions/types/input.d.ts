...
import { CosmosDBInput, CosmosDBInputOptions } from '@azure/functions/types/cosmosDB';
import { GenericInputOptions } from '@azure/functions/types/generic';
import { FunctionInput } from '@azure/functions';
import { MySqlInput, MySqlInputOptions } from '@azure/functions/types/mySql';
import { SqlInput, SqlInputOptions } from '@azure/functions/types/sql';
import { StorageBlobInput, StorageBlobInputOptions } from '@azure/functions/types/storage';
import { TableInput, TableInputOptions } from '@azure/functions/types/table';
import {
    WebPubSubConnectionInput,
    WebPubSubConnectionInputOptions,
    WebPubSubContextInput,
    WebPubSubContextInputOptions,
} from '@azure/functions/types/webpubsub';
