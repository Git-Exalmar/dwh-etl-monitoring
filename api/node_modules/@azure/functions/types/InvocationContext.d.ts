...
import { FunctionInput, FunctionOutput, FunctionTrigger, LogLevel } from '@azure/functions';
import { MySqlInput, MySqlOutput } from '@azure/functions/types/mySql';
import { ServiceBusQueueOutput, ServiceBusTopicOutput } from '@azure/functions/types/serviceBus';
import { SqlInput, SqlOutput } from '@azure/functions/types/sql';
import { StorageBlobInput, StorageBlobOutput, StorageQueueOutput } from '@azure/functions/types/storage';
import { TableInput, TableOutput } from '@azure/functions/types/table';
import { WebPubSubOutput } from '@azure/functions/types/webpubsub';
