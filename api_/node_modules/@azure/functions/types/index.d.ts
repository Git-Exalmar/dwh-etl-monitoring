...
export * from '@azure/functions/types/connectorTrigger';
export * from '@azure/functions/types/cosmosDB';
export * from '@azure/functions/types/cosmosDB.v3';
export * from '@azure/functions/types/cosmosDB.v4';
...
export * from '@azure/functions/types/hooks/appHooks';
export * from '@azure/functions/types/hooks/HookContext';
export * from '@azure/functions/types/hooks/invocationHooks';
export * from '@azure/functions/types/hooks/logHooks';
...
export { hasMcpContentMarker, McpContent, shouldCreateStructuredContentMarker } from '@azure/functions/types/mcpContentMarker';
export * from '@azure/functions/types/mcpPrompt';
export * from '@azure/functions/types/mcpResource';
export * from '@azure/functions/types/mcpTool';
export * from '@azure/functions/types/mySql';
export * as output from '@azure/functions/types/output';
export * from '@azure/functions/types/serviceBus';
export * from '@azure/functions/types/setup';
export * from '@azure/functions/types/sql';
export * from '@azure/functions/types/storage';
export * from '@azure/functions/types/table';
export * from '@azure/functions/types/timer';
export * as trigger from '@azure/functions/types/trigger';
export * from '@azure/functions/types/warmup';
export * from '@azure/functions/types/webpubsub';

// Export toolProp for fluent tool properties API
export { arg } from '@azure/functions/types/toolProperties';
export type { IToolPropertyBuilder } from '@azure/functions/types/toolPropertyBuilder';
